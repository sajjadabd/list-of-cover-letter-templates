...
\resumeItem{Dev Environment}
     ...
     \resumeItem{Laravel Testing}
        ...
        \resumeItem{Database Seeding}
          { with factories and seeding database it is easier to layout your website with ready to serve json data from server to your front-end}
 \resumeItem{Livewire}
          {add items to your cart without reloading the web page , sync every action you do on the front side with back-end of the same component on the server , it makes every user interaction more joyful to the customer}
      \resumeItemListEnd
